...
ASSESSMENT_CONTROLS = [
    ...
    {
        'domain_code': 'RECOVER',
        'control_code': 'backup_availability',
        'control_title': 'Backup Availability & Snapshot Integrity',
        'control_description': 'Ensure active, automated, and accessible backup systems exist for all critical enterprise data assets.',
        'why_it_matters': 'Without available backups, ransomware recovery is impossible without paying ransom.',
        'weight': 3,
        'remediation_tip': 'Configure automated local and cloud backup routines with regular snapshots.',
        'auto_detectable': True,
        'auto_detect_key': 'backup_availability'
    },
    {
        'domain_code': 'RECOVER',
        'control_code': 'backup_frequency',
        'control_title': 'Backup Frequency & Schedule Compliance',
        'control_description': 'Maintain high-frequency backup intervals (hourly/daily) matching business data modification rates.',
        'why_it_matters': 'Infrequent backups lead to massive data loss during ransomware encryption incidents.',
        'weight': 2,
        'remediation_tip': 'Schedule incremental backups at least every 24 hours with hourly delta tracking for transactional databases.',
        'auto_detectable': False,
        'auto_detect_key': None
    },
    {
        'domain_code': 'RECOVER',
        'control_code': 'backup_isolation',
        'control_title': 'Immutable & Air-Gapped Backup Isolation',
        'control_description': 'Maintain air-gapped, WORM (write-once read-many), or offsite isolated backups disconnected from primary network access.',
        'why_it_matters': 'Modern ransomware strains systematically target and destroy online shadow copies and network backups prior to encryption.',
        'weight': 3,
        'remediation_tip': 'Implement the 3-2-1 backup rule with at least one immutable or offline offsite copy.',
        'auto_detectable': False,
        'auto_detect_key': None
    ...
    {
        'domain_code': 'RECOVER',
        'control_code': 'recovery_procedure_availability',
        'control_title': 'Standardized Technical Recovery Procedures',
        'control_description': 'Maintain detailed, step-by-step technical recovery runbooks for restoring servers, databases, and network services.',
        'why_it_matters': 'Prevents confusion, misconfigurations, and prolonged downtime during high-stress incident recovery operations.',
        'weight': 2,
        'remediation_tip': 'Document clear, step-by-step restoration workflows for all critical infrastructure systems.',
        'auto_detectable': False,
        'auto_detect_key': None
    },
    {
        'domain_code': 'RECOVER',
        'control_code': 'disaster_recovery_plan',
        'control_title': 'Disaster Recovery & Business Continuity Plan Availability',
        'control_description': 'Formalize an executive-approved Disaster Recovery (DR) and Business Continuity Plan (BCP) covering major ransomware outages.',
        'why_it_matters': 'Provides strategic operational alignment, leadership escalation paths, and communication channels during IT infrastructure downtime.',
        'weight': 2,
    ...
    {
        'domain_code': 'RECOVER',
        'control_code': 'rto_readiness',
        'control_title': 'Recovery Time Objective (RTO) Execution Readiness',
        'control_description': 'Validate that technical system restoration speeds meet defined Recovery Time Objective (RTO) thresholds.',
        'why_it_matters': 'Excessive recovery time leads to catastrophic operational paralysis and severe financial losses.',
        'weight': 2,
        'remediation_tip': 'Perform periodic mock restoration drills to benchmark and optimize system recovery times.',
        'auto_detectable': True,
        'auto_detect_key': 'rto_rpo_defined'
    },
    {
        'domain_code': 'RECOVER',
        'control_code': 'rpo_readiness',
        'control_title': 'Recovery Point Objective (RPO) Data Loss Minimization',
        'control_description': 'Validate that backup data freshness guarantees minimal data loss within defined RPO limits.',
        'why_it_matters': 'High RPO gaps result in permanent loss of unrecoverable business transactions post-restoration.',
        'weight': 2,
        'remediation_tip': 'Align backup transaction log shipping frequency with RPO targets.',
        'auto_detectable': False,
        'auto_detect_key': None
    },
    {
        'domain_code': 'RECOVER',
        'control_code': 'restoration_verification',
        'control_title': 'Restoration Verification & Sandbox Testing Readiness',
        'control_description': 'Conduct scheduled technical restoration drills into an isolated sandbox environment to verify data integrity.',
        'why_it_matters': 'Unverified backups frequently fail during real incident recovery due to corruption or missing encryption keys.',
        'weight': 2,
        'remediation_tip': 'Automate monthly test restores into an isolated sandbox environment and validate database bootability.',
        'auto_detectable': True,
        'auto_detect_key': 'restore_tested'
    },
    {
        'domain_code': 'RECOVER',
        'control_code': 'post_incident_recovery',
        'control_title': 'Post-Incident Forensic Cleanliness & Recovery Preparedness',
        'control_description': 'Scan restored backup volumes for hidden web shells, persistence mechanisms, or dormant malware prior to production boot.',
        ...
        'auto_detectable': True,
        'auto_detect_key': 'post_incident_recovery'
    },
